...
M569 P0 S0 ;T0.6:0.6:0.4:0.4                   	; BED oś X  	<- MKS SGEN
...
M569 P4 S0 				       												; Second Z-axis
	;M584 X0 Y1 Z2 E3                               ; set drive mapping with parallel adapter or single z-axis
M584 X0 Y1 Z2:4 E3                             	; set drive mapping <- DUAL Z axis

M92 X80.00 Y80.00 Z400.00 E820.00              	; set steps per mm
...
M574 Y1 S1 P"!ystop"                            ; configure active-high endstop for high end on Y via pin ystop
	;M574 Z1 S1 P"!zstop"                            ; configure active-high endstop for high end on Z via pin zstop - USE ONLY WITH Z-AXIS ENDSTOP
M574 Z1 S2                           						; configure active-high endstop for high end on Z via pin zstop
...
M950 S0 C"1.23"
G31 P25 X-52 Y-20 Z0.218 			; default Z0.0
...
; Miscellaneous
; https://github.com/gloomyandy/RepRapFirmware/wiki/SKR-PanelDue
;M575 P1 S1 B57600                              ; enable support for PanelDue
M575 P1 S3 B57600                               ; enable support for PanelDue MKS TFT28 v3.0
